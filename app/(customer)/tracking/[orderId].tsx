...
export default function OrderTrackingScreen() {
    ...
    const isDriverVisible = smoothedLocation !== null && currentStatus !== 'delivered' && currentStatus !== 'cancelled';
                        ...
                        return (
                            <View key={step.key} style={tw`flex-row`}>
                                <View style={tw`items-center mr-4`}>
                                    <View style={[tw`w-8 h-8 rounded-full items-center justify-center`, { backgroundColor: isUpcoming ? colors.surfaceElevated : `${dotColor}22`, borderWidth: isActive ? 2 : 0, borderColor: dotColor }]}>
